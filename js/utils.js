...
function dxAlertMsg() {
    var msgScope = angular.element(document.getElementById('dxModalPage')).scope()
    if (!msgScope) {
        angular.bootstrap(document.getElementById("dxModalPage"), ["dxModalApp"]);
        msgScope = angular.element(document.getElementById('dxModalPage')).scope()
    }
